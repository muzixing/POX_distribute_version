...
import socket
import thread
from pox.messenger import communication as communication
...
def _post_startup ():
  thread.start_new_thread(communication.distributed_server, (7777,))
  #thread.start_new_thread(communication.distributed_client, ('10.0.0.116',7777,))
  if _options.enable_openflow:
